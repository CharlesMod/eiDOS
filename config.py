...
class Config:
    ...
    pillars_strategy_memory_enabled: bool = False      # SOTA#3 ReasoningBank: distil a trigger→principle guardrail engram when a quest/objective closes (strategy.py)
...
def load_config(path: str = "config.toml") -> Config:
    ...
    if data:
        ...
        config.pillars_strategy_memory_enabled = pillars.get("strategy_memory_enabled", config.pillars_strategy_memory_enabled)
